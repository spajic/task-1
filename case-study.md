...
## Результаты
В результате проделанной оптимизации наконец удалось обработать файл с данными всего за 86.1093 секунды
Удалось улучшить метрику системы (время прогона по файлу 10к строк) с 3.5 секунд до 0.1498 секунд - метрика улучшилась в 23 раза!
